...
class AbonnementRepository extends ServiceEntityRepository
{
    ...
    ////bch traja3li liste des evenements eli l user aamel feha participation

    public function selectbyAcademie($str)
    {
        return $this->getEntityManager()
            ->createQuery(
                'SELECT a FROM APP\Entity\Academie a
            JOIN a.abonnements aa
            WHERE aa.user = :str'
            )
    ...
    public function delete($idacademie,$iduser)
    {
        return $this->getEntityManager()
            ->createQuery(
                'DELETE FROM APP\Entity\Abonnement aa
            WHERE aa.user= :field1 AND aa.academie=:field2 '
            )        ->setParameters([
                'field1' => $iduser ,
                'field2' => $idacademie,
            ])->execute();
