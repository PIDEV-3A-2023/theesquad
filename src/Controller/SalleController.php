...
class SalleController extends AbstractController
{
    ...
    #[Route('/frontaffichagesalle',name: 'affichage_salle_front')]
    public function indexFront(SalleRepository $salleRepository): Response
    {
        $salle=$salleRepository->findAll();
        return $this->render('salle/frontsalle.html.twig',['salle'=>$salle]);
    }
