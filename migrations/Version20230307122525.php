 ...
 */
final class Version20230307122525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE espace CHANGE image image VARCHAR(255) NOT NULL, CHANGE tarifhoraire tarifhoraire DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE espace CHANGE image image VARCHAR(255) DEFAULT NULL, CHANGE tarifhoraire tarifhoraire DATETIME DEFAULT NULL');
    }
}
