 ...
 */
final class Version20230213235412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE espace (id INT AUTO_INCREMENT NOT NULL, categorielocation_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, caracteristique VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, dispo VARCHAR(255) NOT NULL, tarifhoraire DATETIME DEFAULT NULL, prixlocation DOUBLE PRECISION NOT NULL, INDEX IDX_6AB096DFBCF1B5A (categorielocation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
