 ...
 */
class getCategorieLocationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategorieLocationRepository' shared autowired service.
     *
     * @return \App\Repository\CategorieLocationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategorieLocationRepository.php';

        return $container->privates['App\\Repository\\CategorieLocationRepository'] = new \App\Repository\CategorieLocationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
