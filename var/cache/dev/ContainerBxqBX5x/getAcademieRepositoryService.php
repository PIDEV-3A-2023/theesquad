 ...
 */
class getAcademieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcademieRepository' shared autowired service.
     *
     * @return \App\Repository\AcademieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcademieRepository.php';

        return $container->privates['App\\Repository\\AcademieRepository'] = new \App\Repository\AcademieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
