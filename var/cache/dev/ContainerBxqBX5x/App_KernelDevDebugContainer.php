...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'flasher.toastr' => 'getFlasher_ToastrService',
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AcademieController' => 'getAcademieControllerService',
            'App\\Controller\\AdminController' => 'getAdminControllerService',
            'App\\Controller\\AlimentController' => 'getAlimentControllerService',
            'App\\Controller\\CategorieLocationController' => 'getCategorieLocationControllerService',
            'App\\Controller\\CategorieProduitController' => 'getCategorieProduitControllerService',
            ...
            'App\\Controller\\EspaceController' => 'getEspaceControllerService',
            ...
            'App\\Controller\\RoutineController' => 'getRoutineControllerService',
            'App\\Controller\\RoutineControllerFront' => 'getRoutineControllerFrontService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'php-flasher'.\DIRECTORY_SEPARATOR.'flasher-toastr'.\DIRECTORY_SEPARATOR.'ToastrFactory.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('cnIcRmeImK', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('W1SPHW7owj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8byewQo0M4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\AcademieRepository' => ['privates', 'App\\Repository\\AcademieRepository', 'getAcademieRepositoryService', true],
            ...
            'App\\Repository\\CategorieLocationRepository' => ['privates', 'App\\Repository\\CategorieLocationRepository', 'getCategorieLocationRepositoryService', true],
            ...
            'App\\Repository\\EspaceRepository' => ['privates', 'App\\Repository\\EspaceRepository', 'getEspaceRepositoryService', true],
            ...
            'App\\Repository\\ObjectifRepository' => ['privates', 'App\\Repository\\ObjectifRepository', 'getObjectifRepositoryService', true],
            ...
            'App\\Repository\\RoutineRepository' => ['privates', 'App\\Repository\\RoutineRepository', 'getRoutineRepositoryService', true],
            ...
            'App\\Repository\\AcademieRepository' => '?',
            'App\\Repository\\AdminRepository' => '?',
            'App\\Repository\\AlimentRepository' => '?',
            'App\\Repository\\CategorieLocationRepository' => '?',
            ...
            'App\\Repository\\EspaceRepository' => '?',
            ...
            'App\\Repository\\RoutineRepository' => '?',
    ...
    protected function getFlasherService()
    {
        ...
        $b->addScripts('toastr', ['cdn' => [0 => 'https://cdn.jsdelivr.net/npm/jquery@3.6.3/dist/jquery.min.js', 1 => 'https://cdn.jsdelivr.net/npm/@flasher/flasher-toastr@1.2.4/dist/flasher-toastr.min.js'], 'local' => [0 => '/vendor/flasher/jquery.min.js', 1 => '/vendor/flasher/flasher-toastr.min.js']]);
        $b->addStyles('toastr', []);
        $b->addOptions('toastr', []);
        ...
        $instance->addFactory('toastr', ($this->services['flasher.toastr'] ?? $this->getFlasher_ToastrService()));
    ...
    /**
     * Gets the public 'flasher.toastr' shared service.
     *
     * @return \Flasher\Toastr\Prime\ToastrFactory
     */
    protected function getFlasher_ToastrService()
    {
        return $this->services['flasher.toastr'] = new \Flasher\Toastr\Prime\ToastrFactory(($this->privates['flasher.storage_manager'] ?? $this->getFlasher_StorageManagerService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('swqAncwsVz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MK0gn+ewgw', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sTa7DWkVEB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MhpnB+3KfD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TxNxVAkfxT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fqRBVHou2K', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pVrGjDZgrn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'FlasherToastrSymfonyBundle' => 'Flasher\\Toastr\\Symfony\\FlasherToastrSymfonyBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'FlasherToastrSymfonyBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'php-flasher'.\DIRECTORY_SEPARATOR.'flasher-toastr-symfony'),
            ...
            'Client_directory' => (\dirname(__DIR__, 4).'/public/Client_img'),
            'image_directory' => (\dirname(__DIR__, 4).'/public/Back/img'),
            'diplome_directory' => (\dirname(__DIR__, 4).'/public/diplome_img'),
