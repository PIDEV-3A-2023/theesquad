 ...
 */
class getRoutineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RoutineRepository' shared autowired service.
     *
     * @return \App\Repository\RoutineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RoutineRepository.php';

        return $container->privates['App\\Repository\\RoutineRepository'] = new \App\Repository\RoutineRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
