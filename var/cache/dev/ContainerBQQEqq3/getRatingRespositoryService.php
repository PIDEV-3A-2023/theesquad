...
{
    /**
     * Gets the private 'App\Repository\RatingRespository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RatingRespository.php';

        return $container->privates['App\\Repository\\RatingRespository'] = new \App\Repository\RatingRespository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
