 ...
 */
class getParticipationRespositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticipationRespository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipationRespository.php';

        return $container->privates['App\\Repository\\ParticipationRespository'] = new \App\Repository\ParticipationRespository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
